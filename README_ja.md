...
- **センサーのデコード**: 以下の主要なBLEセンサーのアドバタイズデータをデコードします：
    ...
    | **Inkbird** | IBS-TH1/TH2/IAM-T1/等 | 温度、湿度、バッテリー、気圧、(一部モデルはCO2) |
...
| `-idByName` | `TWBLE2MQTT_IDBYNAME` | ランダムアドレスのデバイスIDにデバイス名とタイプを使用 | `false` |
...
twBLE2MQTTで収集したデータは、[TWSNMP FK](https://twsnmp.github.io/twsnmpfk/)でモニターすることができます。
